...
const Interactive: React.FC<{children: React.ReactElement<any>, variant?: 'link' | 'text'}> = ({ children, variant = 'link' }) => {
  ...
  // Ensure children can accept ref by forwarding it or checking if it's a valid element
...
const Hero: React.FC<{onNavigate: HomePageProps['onNavigate']}> = ({ onNavigate }) => (
  // Hero Section
  <section id="home" className="relative min-h-screen flex flex-col justify-start pt-20 lg:pt-0 pb-12 lg:pb-20 overflow-hidden perspective-1000">
    ...
    <div className="container mx-auto px-4 sm:px-6 relative z-20 pointer-events-none flex flex-col justify-center min-h-[85vh] lg:min-h-screen lg:-mt-10">
      
      {/* Grid */}
      <div className="grid lg:grid-cols-2 gap-12 items-center pointer-events-none -mt-12 lg:-mt-49">
          
          {/* Main Text Content */}
          <div className="text-center lg:text-left z-30 pointer-events-auto mt-25 lg:mt-20">
              <div className="hero-stagger inline-flex items-center px-6 py-2 rounded-full border border-secondary/50 bg-secondary/10 mb-8 shadow-[0_0_15px_rgba(34,211,238,0.2)] backdrop-blur-sm pointer-events-auto">
                <span className="w-2 h-2 bg-secondary rounded-full mr-3 animate-pulse"></span>
                <span className="text-sm font-bold tracking-widest text-secondary uppercase">New Zealand's Trusted Business Partner</span>
              </div>
              <h1 className="hero-stagger text-4xl sm:text-5xl md:text-7xl font-bold mb-8 leading-[1.1] tracking-tight text-light-text drop-shadow-2xl pointer-events-auto">
              ...
              <div className="pointer-events-auto">
                <Interactive variant="text">
                    <p className="hero-stagger text-lg lg:text-xl mb-12 text-muted-text leading-relaxed max-w-2xl mx-auto lg:mx-0 font-light drop-shadow-lg">
              ...
              <div className="hero-stagger flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center lg:justify-start pointer-events-auto w-full sm:w-auto">
                <Magnetic>
                    <Interactive>
          ...
          {/* Second Spline Element */}
          <div className="hidden lg:block h-[800px] w-full relative pointer-events-auto z-30">
               <div className="absolute inset-0 w-full h-full overflow-hidden rounded-[3rem]">
                   <div className="absolute w-[150%] h-[150%] -top-[25%] -left-[20%]">
                       {/* @ts-ignore */}
...
const About: React.FC<{onNavigate: HomePageProps['onNavigate']}> = ({ onNavigate }) => {
    return (
        <section id="about" className="relative py-16 lg:py-32 border-t border-glass-border">
                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    <div className="space-y-10 order-2 lg:order-1">
                        <div>
                            ...
                            <h2 className="reveal-text text-4xl sm:text-5xl font-bold text-light-text leading-tight">We turn ambition into <span className="text-secondary italic">lasting momentum</span></h2>
                        </div>
                         <Interactive variant="text">
                            <div className="reveal-text space-y-6 text-lg text-muted-text font-light leading-relaxed">
                                <p>
                    ...
                    {/* Image from Assets - Responsive Height */}
                    <div className="relative order-1 lg:order-2 h-[300px] sm:h-[400px] lg:h-[500px] w-full reveal-card overflow-hidden rounded-3xl border border-glass-border group">
                       ...
                       <img src={assets.hero.about} alt="About Capital Media Partners" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" />
...
const HowWeWork: React.FC = () => {
  ...
  return (
    <section className="py-16 lg:py-32 relative border-t border-glass-border">
      <div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-6">
        <div className="text-center mb-20">
          <div className="reveal-text inline-flex items-center px-6 py-2 rounded-full border border-secondary/50 bg-secondary/10 mb-6 shadow-[0_0_15px_rgba(34,211,238,0.2)] backdrop-blur-sm">
            <span className="text-sm font-bold tracking-widest text-secondary uppercase">Our Process</span>
          </div>
          <h2 className="reveal-text text-4xl sm:text-5xl font-bold text-light-text leading-tight mb-6">How We Work</h2>
          <Interactive variant="text">
            <p className="reveal-text text-xl text-muted-text leading-relaxed max-w-2xl mx-auto">Our proven three-step process ensures your success from discovery to delivery.</p>
          </Interactive>
        </div>
...
const Services: React.FC<{onNavigate: HomePageProps['onNavigate']}> = ({ onNavigate }) => {
    ...
    return (
        <section id="services" className="relative py-16 lg:py-32 border-t border-glass-border">
            <div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-6">
                    ...
                    <div className="lg:col-span-4">
                        <div className="sticky top-32 space-y-8">
                            <div>
                                ...
                                <h2 className="reveal-text text-4xl sm:text-5xl font-bold text-light-text leading-tight mt-4">Tailored services for <span className="text-primary">every stage</span></h2>
                            </div>
                            <Interactive variant="text">
                                <p className="reveal-text text-lg text-muted-text leading-relaxed">
                        ...
                        {serviceList.map((service, index) => (
                            <a href="#" onClick={(e) => { e.preventDefault(); onNavigate(service.page); }} key={index} className="reveal-card group bg-dark-bg/50 border border-glass-border p-8 rounded-3xl backdrop-blur-md transition-all duration-500 hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10 flex flex-col">
                                ...
                                <h3 className="text-2xl font-bold text-light-text mb-3 group-hover:translate-x-1 transition-transform">{service.title}</h3>
                                 <Interactive variant="text"><p className="text-muted-text leading-relaxed flex-grow">{service.description}</p></Interactive>
...
const Products: React.FC<{onNavigate: HomePageProps['onNavigate']}> = ({ onNavigate }) => {
    ...
    return (
    <>
    <section className="py-16 lg:py-32 px-4 sm:px-6 relative border-t border-glass-border">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="reveal-text text-4xl md:text-5xl font-bold mb-6 text-light-text">Our Products</h2>
          <Interactive variant="text"><p className="reveal-text text-xl text-muted-text max-w-2xl mx-auto">Cutting-edge solutions designed to revolutionize how businesses operate.</p></Interactive>
        </div>
        <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto perspective-1000">
          ...
          <div className="reveal-card bg-gradient-to-b from-white/5 to-transparent p-10 rounded-3xl border border-glass-border backdrop-blur-lg flex flex-col items-center text-center hover:border-primary/30 transition-all duration-500">
             <div className="h-32 flex items-center justify-center mb-8 w-full bg-white/5 rounded-2xl p-2 overflow-hidden relative group cursor-pointer" onClick={() => setIsPlannerOpen(true)}>
                <img src={assets.products.wallPlanner} alt="Wall Planner" className="h-full object-contain rounded transition-transform duration-500"></img>
            ...
            <div className="mt-auto w-full flex flex-col gap-3">
                 <Magnetic>
                     <Interactive><a href="#contact" onClick={(e) => { e.preventDefault(); onNavigate('contact'); }} className="w-full inline-flex justify-center items-center gap-2 px-6 py-4 bg-gradient-to-r from-primary to-primary-dark text-white font-bold rounded-xl shadow-lg hover:shadow-primary/40 transition-all duration-300">
    ...
    <AnimatePresence>
        {isPlannerOpen && (
            ...
            >
                <div className="relative w-full max-w-7xl max-h-full overflow-auto flex items-center justify-center">
                    <button 
                        onClick={() => setIsPlannerOpen(false)}
                        className="absolute top-4 right-4 z-50 w-12 h-12 bg-white/10 rounded-full flex items-center justify-center text-white hover:bg-primary transition-colors"
                    >
...
const Clients: React.FC = () => {
    ...
    return (
        <section className="py-10 lg:py-16 px-4 sm:px-6 border-b border-glass-border">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                     <div className="inline-flex items-center px-6 py-2 rounded-full border border-secondary/50 bg-secondary/10 mb-8 shadow-[0_0_15px_rgba(34,211,238,0.2)] backdrop-blur-sm">
                        <span className="text-sm font-bold tracking-widest text-secondary uppercase font-outfit">Our Network</span>
                    </div>
                    <h2 className="text-3xl md:text-4xl font-bold text-light-text">Trusted by NZ Businesses</h2>
                </div>
                
                {/* Gradient Border Wrapper */}
                <div className="relative w-full rounded-[3rem] p-[2px] bg-gradient-to-r from-primary via-purple-500 to-secondary shadow-[0_0_30px_rgba(139,92,246,0.3)]">
                    <div className="relative w-full overflow-hidden group rounded-[calc(3rem-2px)] py-12 bg-white">
                        ...
                        <div className="flex w-max animate-marquee group-hover:[animation-play-state:paused] items-center">
                            {allLogos.map((logo, index) => (
                                <div key={index} className="mx-6">
                                    <Magnetic>
                                        <Interactive>
                                            <a href={logo.url} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-64 h-36 bg-white rounded-2xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgba(139,92,246,0.25)] hover:border-primary/20 transition-all duration-500 ease-out transform hover:-translate-y-1 relative overflow-hidden group/card">
                                                
                                                {/* Subtle shine effect on hover */}
                                                <div className="absolute inset-0 bg-gradient-to-tr from-primary/5 via-transparent to-secondary/5 opacity-0 group-hover/card:opacity-100 transition-opacity duration-500"></div>
                                                
                                                <img src={`${assets.clients.basePath}${logo.file}`} 
                                                     className="max-h-20 max-w-[80%] w-auto object-contain transition-transform duration-500 group-hover/card:scale-110 filter group-hover/card:brightness-105 rounded-xl"
...
const Partnership: React.FC = () => (
    <section className="py-16 lg:py-32 px-4 sm:px-6 border-t border-glass-border">
        <div className="max-w-5xl mx-auto text-center reveal-card bg-white/5 border border-glass-border rounded-3xl p-10 sm:p-16 backdrop-blur-lg">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-10 text-light-text">Official Partnership</h2>
            <div className="flex justify-center mb-10 transform hover:scale-105 transition-transform duration-500">
                 <a href="https://childcancer.org.nz/" target="_blank" rel="noopener noreferrer">
                    <img src={assets.clients.childCancerLogo} alt="Child Cancer Foundation Logo" className="h-28 w-auto brightness-200 drop-shadow-[0_0_15px_rgba(236,72,153,0.5)]"></img>
                 </a>
            </div>
            <Interactive variant="text">
                <p className="text-xl text-muted-text leading-relaxed max-w-3xl mx-auto font-light">
...
const Contact: React.FC<{onNavigate: HomePageProps['onNavigate']}> = ({ onNavigate }) => {
    ...
    return (
        <section id="contact" className="py-16 lg:py-32 px-4 sm:px-6 relative overflow-hidden border-t border-glass-border">
            ...
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-20">
                    <h2 className="reveal-text text-5xl md:text-6xl font-bold mb-8 text-light-text tracking-tight">Let's Build <span className="text-secondary">Together</span></h2>
                    <Interactive variant="text"><p className="reveal-text text-xl text-muted-text max-w-2xl mx-auto">Ready to scale? We'd love to hear from you and discuss how we can help your business grow.</p></Interactive>
                </div>
                <div className="grid md:grid-cols-2 gap-8 mb-12 perspective-1000">
                    ...
                    <div className="reveal-card flex items-center p-8 bg-white/5 border border-glass-border rounded-3xl backdrop-blur-lg hover:bg-white/10 transition-colors">
                        ...
                        <div>
                             ...
                             <div className="flex items-center gap-3">
                                {/* Reduced font size for better proportion */}
